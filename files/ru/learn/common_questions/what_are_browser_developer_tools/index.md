...
- _**Панель Меню.**_
  ...
  - **Firefox.** Открыть меню ![](2014-01-10-13-08-08-f52b8c.png) _➤ ![](https://mdn.mozillademos.org/files/9639/Screenshot%20from%202014-11-26%2014:24:56.png) _➤ Инструменты разработки, или_ _Инструменты ➤_ _Веб-разработка ➤ Инструменты разработки_
